...
ALX_ALIAS_WEAK_DEFINITION(strtoi8_s,	alx_strtoi8_s);
ALX_ALIAS_WEAK_DEFINITION(strtoi16_s,	alx_strtoi16_s);
ALX_ALIAS_WEAK_DEFINITION(strtoi32_s,	alx_strtoi32_s);
ALX_ALIAS_WEAK_DEFINITION(strtoi64_s,	alx_strtoi64_s);
#endif
