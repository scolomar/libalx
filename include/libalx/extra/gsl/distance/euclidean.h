...
__attribute__((always_inline, const))
float	distance2D_euclidean_8b		(uint8_t dx, uint8_t dy)
{
	return	alx_gsl_distance2D_euclidean_8b(dx, dy);
}

__attribute__((always_inline, const))
float	distance2D_euclidean_16b	(uint16_t dx, uint16_t dy)
{
	return	alx_gsl_distance2D_euclidean_16b(dx, dy);
}

__attribute__((always_inline, const))
double	distance2D_euclidean_32b	(uint32_t dx, uint32_t dy)
{
	return	alx_gsl_distance2D_euclidean_32b(dx, dy);
}

__attribute__((always_inline, const))
long double distance2D_euclidean_64b	(uint64_t dx, uint64_t dy)
{
